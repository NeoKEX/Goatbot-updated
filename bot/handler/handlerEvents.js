...
function getRole(threadData, senderID, userData) {
...
module.exports = function (api, threadModel, userModel, dashBoardModel, globalModel, usersData, threadsData, dashBoardData, globalData) {
        return async function (event, message) {
                ...
                const role = getRole(threadData, senderID, userData);
                const parameters = {
                ...
                */
                ...
                async function onStart() {
                        ...
                        if (role === 2) {
                                ...
                                // Role 2 commands are admin-only
                                hasPermission = false;
                        } else if (needRole === 3) {
                                // Role 3 commands need role 3 or admin
                                hasPermission = role === 3;
                        } else {
                                // Roles 0 and 1 use traditional hierarchy
                                hasPermission = role >= needRole;
                        }
