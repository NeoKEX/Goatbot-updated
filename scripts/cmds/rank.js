...
const defaultDesignCard = {
        widthCard: 2000,
        heightCard: 500,
        main_color: ["#1a1a1a", "#0a0a0a"],
        sub_color: ["rgba(255, 140, 0, 0.2)", "rgba(255, 69, 0, 0.15)"],
        alpha_subcard: 0.95,
        exp_color: ["#FF8C00", "#FF4500"],
        expNextLevel_color: "rgba(50, 50, 50, 0.8)",
        text_color: "#FFFFFF",
        name_color: ["#FF8C00", "#FFD700"],
        level_color: "#FF8C00",
        rank_color: ["#FF8C00", "#FFD700"],
        exp_text_color: "#E0E0E0",
        line_color: ["#FF8C00", "#FF4500"]
};
